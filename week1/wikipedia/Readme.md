# Week 1 - Weekipedia project
To start, first download the assignment: wikipedia.zip. For this assignment, you also need to download the [data (133 MB)](http://alaska.epfl.ch/~dockermoocs/bigdata/wikipedia.dat):
...
1
List(("Scala", 999999), ("JavaScript", 1278), ("LOLCODE", 982), 
    ("Java", 42))
